                ...
                <SunBtn color={C.coral} full onClick={async () => {
                  try {
                    ...
                    if (emailDest) {
                      ...
                      const emailHtml = `<!DOCTYPE html><html lang="fr" xmlns="http://www.w3.org/1999/xhtml"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta http-equiv="X-UA-Compatible" content="IE=edge"><title>Carte Liberté — Eole Beach Club</title></head><body style="margin:0;padding:0;background-color:#f5f9ff;font-family:Arial,Helvetica,sans-serif;"><table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#f5f9ff"><tr><td align="center" style="padding:30px 10px;"><table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%;"><tr><td bgcolor="#FF8E53" align="center" style="padding:32px 40px;background-color:#FF8E53;"><p style="margin:0 0 6px;font-size:40px;line-height:1;">🎟️</p><h1 style="margin:0 0 6px;font-size:22px;font-weight:900;color:#ffffff;font-family:Arial,Helvetica,sans-serif;">Demande de Carte Liberté</h1><p style="margin:0;font-size:13px;color:#ffffff;font-family:Arial,Helvetica,sans-serif;">Eole Beach Club &middot; Saison 2026</p></td></tr><tr><td bgcolor="#ffffff" style="padding:32px 40px;background-color:#ffffff;"><p style="font-size:16px;color:#2C3E50;margin:0 0 6px;font-family:Arial,Helvetica,sans-serif;">Bonjour <strong>${prenom} ${nom}</strong>,</p><p style="font-size:14px;color:#555555;line-height:1.7;margin:0 0 18px;font-family:Arial,Helvetica,sans-serif;">Votre demande de <strong>Carte Liberté &middot; ${selectedLiberte.label}</strong> a bien été enregistrée.</p><table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:20px;"><tr><td bgcolor="#EFF6FF" style="background-color:#EFF6FF;border-radius:10px;padding:16px 18px;border:1.5px solid #1A8FE3;"><p style="margin:0 0 4px;font-size:15px;font-weight:700;color:#1A8FE3;font-family:Arial,Helvetica,sans-serif;">🎟️ Carte Liberté &middot; ${selectedLiberte.label}</p><p style="margin:0 0 4px;font-size:24px;font-weight:900;color:#FF8E53;font-family:Arial,Helvetica,sans-serif;">${selectedLiberte.price} &euro;</p><p style="margin:0;font-size:13px;color:#555555;font-family:Arial,Helvetica,sans-serif;">📅 Valable du 6 juillet au 22 août 2026</p></td></tr></table>${blocReglement}<p style="font-size:13px;color:#888888;margin-top:8px;font-family:Arial,Helvetica,sans-serif;">Vos demi-journées seront créditées sur votre Carte Liberté <strong>dès réception du paiement</strong>.</p><table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top:24px;border-top:1px solid #eeeeee;padding-top:16px;"><tr><td style="font-size:12px;color:#aaaaaa;font-family:Arial,Helvetica,sans-serif;line-height:1.8;"><strong style="color:#555555;">🏖️ Eole Beach Club</strong><br>Plage Saint-Michel &middot; 44420 Piriac-sur-Mer<br><a href="mailto:clubdeplage.piriacsurmer@hotmail.com" style="color:#FF8E53;text-decoration:none;">clubdeplage.piriacsurmer@hotmail.com</a></td></tr></table></td></tr><tr><td bgcolor="#F0F4F8" align="center" style="padding:14px;background-color:#F0F4F8;font-size:11px;color:#888888;font-family:Arial,Helvetica,sans-serif;line-height:1.8;">Eole Beach Club &mdash; Club de Plage / École de Natation &mdash; Plage Saint-Michel &mdash; 44420 Piriac-sur-Mer</td></tr></table></td></tr></table></body></html>`;
                      try {
