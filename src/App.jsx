...
/* ═══════════════════════════════════════════════════════
   🌊 Poseidon Beach Club  |  Univers Joyeux Plage & Enfants
   ═══════════════════════════════════════════════════════ */
            ...
            <div style={{ background: "linear-gradient(135deg, #003087, #009CDE)", padding: "20px 24px 18px" }}>
              ...
              <div style={{ background: "rgba(255,255,255,0.12)", borderRadius: 14, padding: "12px 16px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                ...
                <div style={{ textAlign: "right" }}>
                  <div style={{ color: "rgba(255,255,255,0.75)", fontSize: 11 }}>Poseidon Beach Club</div>
      ...
      <div style={{ background: "linear-gradient(160deg, #0099FF 0%, #00C9FF 55%, #4ECDC4 100%)", padding: "36px 22px 0", textAlign: "center", position: "relative", overflow: "hidden" }}>
        <div style={{ position: "relative", zIndex: 2 }}>
          <div style={{ display: "inline-block", background: "rgba(255,255,255,0.22)", backdropFilter: "blur(8px)", borderRadius: 50, padding: "4px 20px", marginBottom: 10, border: "2px solid rgba(255,255,255,0.4)" }}>
            <span style={{ color: "#fff", fontSize: 18, fontWeight: 900, letterSpacing: 4, textTransform: "uppercase" }}>Poseidon</span>
          </div>
    ...
    <div style={{ background: C.shell, minHeight: "100%", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "32px 24px", textAlign: "center" }}>
        ...
        <p style={{ color: "#777", fontSize: 15, margin: "0 0 28px", lineHeight: 1.6 }}>
          Pour réserver une séance d'éveil aquatique, tu dois d'abord t'inscrire au Poseidon Beach Club.
        </p>
  ...
  if (!user) return (
    <div style={{ background: C.shell, minHeight: "100%", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "32px 24px", textAlign: "center" }}>
        ...
        <h2 style={{ color: C.dark, fontSize: 22, margin: "0 0 10px" }}>Inscription requise</h2>
        <p style={{ color: "#777", fontSize: 15, margin: "0 0 28px", lineHeight: 1.6 }}>
          Pour réserver un créneau de natation, tu dois d'abord t'inscrire au Poseidon Beach Club.
        </p>
  ...
  if (done) return (
    <div style={{ minHeight: "100%", background: `linear-gradient(160deg, #0099FF 0%, #00C9FF 45%, ${C.sea} 100%)`, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "40px 28px", textAlign: "center", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ position: "relative", zIndex: 2 }}>
        ...
        <p style={{ color: "rgba(255,255,255,0.85)", fontSize: 16, margin: "0 0 32px", fontWeight: 600 }}>Tu fais maintenant partie de la famille Poseidon Beach Club 🌊</p>
        ...
        {step === 1 && (
          <Card>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr", gap: "0 12px" }}>
              <div>
                <FInput label="Ville" value={form.ville} onChange={f("ville")} required placeholder="Ex : La Turballe" />
                {step1Error && !form.ville && <div style={{ fontSize: 12, color: C.sunset, fontWeight: 700, marginTop: -10, marginBottom: 12 }}>⚠️ Obligatoire</div>}
              </div>
              <div>
                <FInput label="Code postal" value={form.cp} onChange={f("cp")} required placeholder="44420" />
              ...
              <div style={{ background: `${C.sunset}18`, border: `2px solid ${C.sunset}`, borderRadius: 14, padding: "10px 14px", marginBottom: 14, display: "flex", alignItems: "center", gap: 10 }}>
                ...
                <span style={{ fontSize: 13, fontWeight: 700, color: C.sunset }}>
                  {form.email && !emailValid ? "L'adresse email n'est pas valide (ex : prenom@exemple.fr)"
                    : form.cp && !cpValid ? "Le code postal doit contenir 5 chiffres (ex : 44420)"
        ...
        {step === 3 && (
          <Card>
            ...
            <div style={{ background: `${C.sky}20`, border: `2px solid ${C.sky}`, borderRadius: 16, padding: 16, marginBottom: 20, fontSize: 14, color: "#555", lineHeight: 1.7 }}>
              Dans le cadre des activités du Poseidon Beach Club, des photos et/ou vidéos pourront être réalisées lors des séances. Ces images peuvent être utilisées à des fins de communication non commerciale.
            </div>
            {[
              { key: "droitImage",    label: "J'autorise le Poseidon Beach Club à photographier et/ou filmer mon/mes enfant(s) lors des activités.", icon: "📷" },
            ...
            <div style={{ background: `${C.deep}08`, border: `1.5px solid ${C.deep}25`, borderRadius: 14, padding: 14, marginBottom: 14 }}>
              ...
              <div onClick={() => setForm(p => ({ ...p, cgvAccepted: !p.cgvAccepted }))} style={{ display: "flex", alignItems: "flex-start", gap: 10, cursor: "pointer" }}>
                ...
                <div style={{ fontSize: 12, color: "#555", lineHeight: 1.5 }}>
                  J'ai lu et j'accepte les <span style={{ color: C.ocean, fontWeight: 700, cursor: "pointer" }} onClick={(e) => { e.stopPropagation(); onNav("infos"); }}>Conditions Générales de Vente</span> ainsi que le règlement intérieur du Poseidon Beach Club, et j'autorise la prise en charge de mon/mes enfant(s) dans le cadre des activités.
                </div>
              </div>
            </div>
      ...
      <div style={{ padding: "10px 18px 24px", display: "flex", flexDirection: "column", gap: 14 }}>
        ...
        <Card style={{ background: `linear-gradient(135deg, ${C.sky}18, ${C.sea}10)` }}>
          ...
          <div style={{ fontSize: 14, color: "#555", lineHeight: 2.4 }}>
            <div>🏖️ <strong>Poseidon Beach Club</strong></div>
            <div>📍 Plage des Bretons - Boulevard Bellanger, 44420 La Turballe</div>
            <div>📞 <a href="tel:0240000000" style={{ color: C.ocean, fontWeight: 700 }}>02 40 00 00 00</a></div>
            <div>✉️ <a href="mailto:clubdeplage.laturballe@hotmail.com" style={{ color: C.ocean, fontWeight: 700 }}>clubdeplage.laturballe@hotmail.com</a></div>
            <div>🌐 <a href="https://www.clubdeplage-laturballe.fr" target="_blank" rel="noreferrer" style={{ color: C.ocean, fontWeight: 700 }}>www.clubdeplage-laturballe.fr</a></div>
          </div>
        </Card>
        ...
        <Card style={{ border: `2px solid ${C.deep}22` }}>
          ...
          <div style={{ marginTop: 14, background: "#F0F4F8", borderRadius: 12, padding: "10px 12px", fontSize: 11, color: "#888", textAlign: "center" }}>
            ...
            <span style={{ color: C.ocean, fontWeight: 700 }}>Poseidon Beach Club · La Turballe · Saison 2026</span>
          </div>
        </Card>
      </div>
    </div>
...
// ── ADMIN DATA ────────────────────────────────────────────
const MEMBRES = [
  { id: 1, name: "Martin Dupont",  email: "martin@gmail.com",  phone: "06 00 00 00 00", adresse: "12 rue de la Mer, 44420 La Turballe", av: "👨", color: C.ocean,
    enfants: [
  ...
  { id: 2, name: "Sophie Bernard", email: "sophie@gmail.com",  phone: "06 12 34 56 78", adresse: "4 allée des Pins, 44420 La Turballe", av: "👩", color: C.coral,
    enfants: [
  ...
  { id: 3, name: "Pierre Martin",  email: "pierre@gmail.com",  phone: "06 55 44 33 22", adresse: "8 bd de l'Océan, 44420 La Turballe", av: "👨", color: C.green,
    enfants: [
  ...
  { id: 4, name: "Julie Leroy",    email: "julie@gmail.com",   phone: "06 77 88 99 11", adresse: "2 impasse des Goélands, 44420 La Turballe", av: "👩", color: "#9B59B6",
    enfants: [
...
<div class="footer">Poseidon Beach Club · Saison 2026 · Imprimé le ${new Date().toLocaleDateString('fr-FR')}</div>
</body></html>`;
